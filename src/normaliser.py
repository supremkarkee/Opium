...
# Controlled dictionary to map informal asset names to standardized vendor/product CPE keys
...
def normalise_asset_name(asset_name: str, threshold: int = 75) -> dict[str, Any]:
    """
    Map informal user software names to standard vendor/product pairs.
    Uses RapidFuzz for fuzzy matching against NORMALISATION_MAP.
    """
